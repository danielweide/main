...
It is advisable for you to include tag as it allows you to search for certain group of people with ease such as using link:#Filtering list by tags : `tag`[filter by tags] features.
